...
- [**RPGBench**](https://arxiv.org/abs/2502.00595): a benchmark for evaluating LLMs as *role-playing game engines* (game creation + simulation) with robust validity checks.
- [**Event-based knowledge editing**](https://aclanthology.org/2024.emnlp-main.282/): defining editing boundaries and model behaviors under conflicting context.
